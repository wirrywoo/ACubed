...
\node[inner sep=0pt] (up) at (0,1.5)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (right) at (3,1.5)
    {\includegraphics[width=1cm]{figures/004/right.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(a)} Jump}]{};
    \end{scope}
...
\node[inner sep=0pt] (up) at (0,1.5)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (up) at (1,1.5)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] (right) at (3,1.5)
    {\includegraphics[width=1cm]{figures/004/right.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(b)} Hand}]{};
    \end{scope}
...
\node[inner sep=0pt] (up) at (1,1.5)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] (up) at (2,1.5)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] (right) at (3,1.5)
    {\includegraphics[width=1cm]{figures/004/right.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(c)} Quad}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (1,2.4)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] (right) at (2,2.1)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (1,1.8)
    {\includegraphics[width=1cm]{figures/008/down.png}};
\node[inner sep=0pt] (right) at (2,1.5)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (1,1.2)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(a)} Trill}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (2,2.4)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] (right) at (3,2.1)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (2,1.8)
    {\includegraphics[width=1cm]{figures/008/up.png}};
\node[inner sep=0pt] (right) at (3,1.5)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (2,1.2)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(b)} One-Handed Trill}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,1.5)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (up) at (1,1.2)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(c)} Jumptrill}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (2,3.2)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] (right) at (2,2.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (2,2.2)
    {\includegraphics[width=1cm]{figures/008/up.png}};
\node[inner sep=0pt] (right) at (2,1.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (2,1.2)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(a)} Jacks}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (0,3.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (up) at (2,3.2)
    {\includegraphics[width=1cm]{figures/004/up.png}};
\node[inner sep=0pt] (right) at (3,2.7)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (right) at (2,2.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (2,2.2)
    {\includegraphics[width=1cm]{figures/008/up.png}};
\node[inner sep=0pt] (up) at (1,2.2)
    {\includegraphics[width=1cm]{figures/008/down.png}};
\node[inner sep=0pt] (right) at (1,1.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (right) at (3,1.7)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (up) at (3,1.2)
    {\includegraphics[width=1cm]{figures/004/right.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(b)} JumpJacks}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (2,2.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (right) at (0,2.7)
    {\includegraphics[width=1cm]{figures/016/left.png}};
\node[inner sep=0pt] (up) at (0,2.2)
    {\includegraphics[width=1cm]{figures/008/left.png}};
\node[inner sep=0pt] (up) at (3,2.2)
    {\includegraphics[width=1cm]{figures/008/right.png}};
\node[inner sep=0pt] (up) at (1,2.2)
    {\includegraphics[width=1cm]{figures/008/down.png}};
\node[inner sep=0pt] (right) at (1,1.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
...
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(c)} Chordjacks}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (1,4.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (up) at (3,4.2)
    {\includegraphics[width=1cm]{figures/008/right.png}};
\node[inner sep=0pt] (up) at (2,3.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (1,3.2)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] (right) at (0,2.7)
...
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(a)} Streams}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (up) at (3,4.7)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (2,4.2)
    {\includegraphics[width=1cm]{figures/008/up.png}};
\node[inner sep=0pt] (up) at (1,3.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (up) at (0,3.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (right) at (3,2.7)
...
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(b)} Roll}]{};
    \end{scope}
...
\node[inner sep=0pt] (up) at (1,4.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (up) at (0,4.2)
    {\includegraphics[width=1cm]{figures/008/left.png}};
\node[inner sep=0pt] (up) at (3,4.2)
    {\includegraphics[width=1cm]{figures/008/right.png}};
\node[inner sep=0pt] (up) at (2,3.7)
    {\includegraphics[width=1cm]{figures/016/up.png}};
\node[inner sep=0pt] (up) at (3,3.2)
    {\includegraphics[width=1cm]{figures/004/right.png}};
\node[inner sep=0pt] (up) at (1,3.2)
    {\includegraphics[width=1cm]{figures/004/down.png}};
\node[inner sep=0pt] (right) at (0,2.7)
...
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(c)} Jumpstream}]{};
    \end{scope}
...
\node[inner sep=0pt] (up) at (2,2.2)
    {\includegraphics[width=1cm]{figures/008/up.png}};
\node[inner sep=0pt] (up) at (0,1.7+1/3)
    {\includegraphics[width=1cm]{figures/048/left.png}};
\node[inner sep=0pt] (up) at (1,1.7+0.5/3)
    {\includegraphics[width=1cm]{figures/012/down.png}};
    
\node[inner sep=0pt] (right) at (3,1.7)
    {\includegraphics[width=1cm]{figures/016/right.png}};
\node[inner sep=0pt] (up) at (2,1.2+1/3)
    {\includegraphics[width=1cm]{figures/024/up.png}};
\node[inner sep=0pt] (up) at (1,1.2+0.5/3)
    {\includegraphics[width=1cm]{figures/048/down.png}};
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(a)} Bursts}]{};
    \end{scope}
...
\node[inner sep=0pt] (right) at (3,0)
    {\includegraphics[width=1cm]{figures/receptor/right.png}};
\node[inner sep=0pt] (right) at (0,3.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] (right) at (1,2.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (up) at (0,2.2)
    {\includegraphics[width=1cm]{figures/008/left.png}};
\node[inner sep=0pt] (up) at (2,1.2+4/3)
    {\includegraphics[width=1cm]{figures/012/up.png}};
\node[inner sep=0pt] (up) at (3,1.2+2/3)
    {\includegraphics[width=1cm]{figures/012/right.png}};
\node[inner sep=0pt] (up) at (3,1.2+5/3)
    {\includegraphics[width=1cm]{figures/024/right.png}};
\node[inner sep=0pt] (up) at (2,1.2+1/3)
    {\includegraphics[width=1cm]{figures/024/up.png}};
\node[inner sep=0pt] (right) at (1,1.7)
    {\includegraphics[width=1cm]{figures/016/down.png}};
\node[inner sep=0pt] (up) at (0,1.2)
    {\includegraphics[width=1cm]{figures/004/left.png}};
\node[inner sep=0pt] at (1.5, -1) [label=center:{\footnotesize \textit{(b)} Polyrhythms}]{};
    \end{scope}
